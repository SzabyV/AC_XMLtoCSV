...
def build_header_dict(element, parent_map, parent_path="", header_dict=None, keyword_indexes=None, last_keyword_level=-1, currentKeyword = None , duplicate_indexes= None):
    ...
    if (elementTag, level, parent_tag, grandParent_tag) in duplicate_indexes:
        duplicate_indexes[(elementTag, level, parent_tag,grandParent_tag,gGrandParent_tag)] += 1
    else:
        duplicate_indexes[(elementTag, level, parent_tag,grandParent_tag,gGrandParent_tag)] = 0
    ...
    header_dict[(tag, level, parent_tag, index,grandParent_tag,gGrandParent_tag)] = full_tag_path
    ...
    for attr in element.attrib:
        ...
        if currentKeyword:
            ...
            header_dict[(attrName, level, tag, attr_index,parent_tag,grandParent_tag)] = attr_path
        else:
            header_dict[(attr, level, tag, attr_index,parent_tag,grandParent_tag)] = attr_path
...
# Usage:
inputXML = "C:\\Users\\s.veress\\Desktop\\Stiften.xml" #"Z:\\Mitarbeiter\\Szabolcs\\ArchicadVorlage\\AttributenStudie\\345_Linien.xml" Z:\\Mitarbeiter\\Szabolcs\\ArchicadVorlage\\Test.xml
